package com.fabuleux.wuntu.billstore.Dialogs;
...
public class SearchableListDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String strPositiveButton = _strPositiveButtonText == null ? getString(R.string.dialog_list_btn_close) : _strPositiveButtonText;
        alertDialog.setPositiveButton(strPositiveButton, _onClickListener);

        String strTitle = _strTitle == null ? getString(R.string.xml_select_vendor) : _strTitle;
